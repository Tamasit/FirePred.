  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const filterData = jsonData.filter(
        (item) => item.acq_date && item.acq_date.includes("2022")
      );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <Link
          to="/YearPage/Year2023"
          className="link-to-year2023 hover:text-red-500 transition-colors text-l"
          style={{
      ...
      >
        <span className="text-blue-700">ข้อมูลสถิติการเกิดไฟในปี 2022</span>
      </h1>
      <div
        style={{
          ...containerStyle,
