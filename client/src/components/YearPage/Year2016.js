  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const filterData = jsonData.filter(
        (item) => item.acq_date && item.acq_date.includes("2016")
      );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <Link
          to="/YearPage/Year2017"
          className="link-to-year2017 hover:text-red-500 transition-colors text-l"
          style={{
      ...
      >
        <span className="text-blue-700">ข้อมูลสถิติการเกิดไฟในปี 2016</span>
      </h1>
      <div
        style={{
          ...containerStyle,
