...
const Year2014 = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const filterData = jsonData.filter(
        (item) => item.acq_date && item.acq_date.includes("2014")
      );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        <Link
          to="/YearPage/Year2013"
          className="link-to-year2013 hover:text-red-500 transition-colors text-l"
          style={{
        ...
        <Link
          to="/YearPage/Year2015"
          className="link-to-year2015 hover:text-red-500 transition-colors text-l"
          style={{
      ...
      >
        <span className="text-blue-700">ข้อมูลสถิติการเกิดไฟในปี 2014</span>
      </h1>
      <div
        style={{
          ...containerStyle,
