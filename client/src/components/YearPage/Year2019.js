...
const Year2019 = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const filterData = jsonData.filter(
        (item) => item.acq_date && item.acq_date.includes("2019")
      );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        <Link
          to="/YearPage/Year2018"
          className="link-to-year2018 hover:text-red-500 transition-colors text-l"
          style={{
        ...
        <Link
          to="/YearPage/Year2020"
          className="link-to-year2020 hover:text-red-500 transition-colors text-l"
          style={{
      ...
      >
        <span className="text-blue-700">ข้อมูลสถิติการเกิดไฟในปี 2019</span>
      </h1>
      <div
        style={{
          ...containerStyle,
