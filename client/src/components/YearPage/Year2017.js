...
const Year2017 = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const filterData = jsonData.filter(
        (item) => item.acq_date && item.acq_date.includes("2017")
      );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        <Link
          to="/YearPage/Year2016"
          className="link-to-year2016 hover:text-red-500 transition-colors text-l"
          style={{
      ...
      >
        <span className="text-blue-700">ข้อมูลสถิติการเกิดไฟในปี 2017</span>
      </h1>
      <div
        style={{
          ...containerStyle,
